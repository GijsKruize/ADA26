...
def publish_submission_created(submission_id: str, assignment_id: str, learner_id: str):
    payload = {
...
def publish_submission_graded(submission_id: str, assignment_id: str, course_id: str, learner_id: str, score: float, max_score: int, feedback: str, weak_concepts: list, mastered_concepts: list):
    payload = {
        "submission_id": submission_id,
        "assignment_id": assignment_id,
        "course_id": course_id,
